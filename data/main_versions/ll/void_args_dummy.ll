...
define dso_local i32 @__fizzer_private_entry_function() #0 !dbg !18 {
  ...
  call void @__fizzer_method_under_test__(i32 noundef 1, ptr noundef %2), !dbg !28
  ret i32 0, !dbg !29
}
...
!27 = !DILocation(line: 5, column: 37, scope: !18)
!28 = !DILocation(line: 5, column: 5, scope: !18)
!29 = !DILocation(line: 6, column: 5, scope: !18)
