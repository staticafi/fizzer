...
define dso_local i32 @__fizzer_private_entry_function() #0 !dbg !30 {
  ...
  call void @__fizzer_method_under_test__(i32 noundef %3, ptr noundef @__fizzer_private_io_model_cmdline_data), !dbg !42
  ret i32 0, !dbg !43
}
...
!31 = !DIFile(filename: "data/main_versions/c/void_args.c", directory: "/home/marek/root/fizzer/dist", checksumkind: CSK_MD5, checksum: "5027203a2649dee7e6d376236ef48cc0")
...
!40 = !DILocation(line: 7, column: 45, scope: !30)
!41 = !DILocation(line: 7, column: 34, scope: !30)
!42 = !DILocation(line: 7, column: 5, scope: !30)
!43 = !DILocation(line: 8, column: 5, scope: !30)
