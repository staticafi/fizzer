    ...
    : program_options_default(argc, argv)
{
    ...
    add_option("sala_executor", "When specified, the fuzzer will execute Sala program instead of the native binary", "0");
